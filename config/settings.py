...
class Settings(BaseSettings):
    ...
    TAIL_GAME_WINDOW_START: str = Field(default="14:50", description="尾盘博弈买入窗口开始(HH:MM)——评审：14:00-14:45 是尾盘跳水最危险段，收窄到临近收盘(14:50-14:57)形态定型后再买")
    TAIL_GAME_WINDOW_END: str = Field(default="14:57", description="尾盘博弈买入窗口结束(HH:MM)")
